...
source /scratch/project_2002026/multilabel_bert/bertfin/neuro_classifier/multilabel/VENV3/bin/activate
...
#export WORD_VECS="fi:$WVDIR/wiki.multi.fi.vec" #,"en:$WVDIR/wiki.multi.en.vec"
